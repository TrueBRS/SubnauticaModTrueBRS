namespace InspectTool
{
	...
	internal class QuickSlots_UpdateState
	{
		...
		{
			if (__instance._heldItem is null || GameOptions.GetVrAnimationMode() || !Input.GetKeyDown(Plugin.ModOptions.masterKeybindKey) || (DevConsole.instance?.state ?? true) || uGUI_PDA.main.tabOpen != PDATab.None || timeCheck != 0) return;
